...
--indomain_test_indices_file dataset/test_docred_1_doc_indices.json \
--scierc_test_indices_file dataset/test_scierc_1_doc_indices.json \
...
--load_checkpoint checkpoints/fredo_crossdomain_1doc.pt \
--num_epochs 0 \
--support_docs_train 1 \
--support_docs_eval 1 \
--query_docs_train 3 \
--query_docs_eval 3 \
--samples_per_ep 2000 \
